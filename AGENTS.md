...
| Booking status vocabulary (Angefragt … Storniert, the verbs, `status` not flags) | [docs/agents/booking-status-vocabulary.md](docs/agents/booking-status-vocabulary.md) |
